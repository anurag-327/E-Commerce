...
function Card({item})
{
    ...
    return(
        ...
        <Link className='w-[23%] hover:scale-105  transform translate duration-500  h-[20rem]' to={`/product/${item.id}`} >  
        <div className=' relative w-full h-full overflow-hidden rounded-lg '>
        {
            ...
            <img className='object-cover absolute w-full h-full hover:z-[1]   z-[3]' src={item.img} /> 
        ...
        <div>
            ...
            <div className='flex gap-5'>
               ...
               <h3 className='font-bold'>₹{item.discountprice}</h3>
            </div>
        </div>      
    </Link>
